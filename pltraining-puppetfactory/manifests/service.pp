class puppetfactory::service {
  ...
  staging::file { 'puppetfactory-0.3.0.gem':
    source  => 'puppet:///modules/puppetfactory/puppetfactory-0.3.0.gem'
  }
  ...
  package { 'puppetfactory':
    ...
    provider => gem,
    source   => "${staging::path}/puppetfactory/puppetfactory-0.3.0.gem",
    require  => Staging::File['puppetfactory-0.3.0.gem'],
