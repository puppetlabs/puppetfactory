class puppetfactory::service {
  ...
  staging::file { 'puppetfactory-0.3.1.gem':
    source  => 'puppet:///modules/puppetfactory/puppetfactory-0.3.1.gem'
  }
  ...
  package { 'puppetfactory':
    ...
    provider => gem,
    source   => "${staging::path}/puppetfactory/puppetfactory-0.3.1.gem",
